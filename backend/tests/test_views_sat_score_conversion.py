...
#         # Get API response
#         response = client.get('api/v0.1/sat_score_conversions/' + str(self.SATScoreConversion1.pk) + '/')
...
#         # GET API response
#         response = client.get('api/v0.1/sat_score_conversions/6/')
...
#         response = client.put('api/v0.1/sat_score_conversions?testid=' + str(self.SATScoreConversion1.pk),
#             data=json.dumps(self.valid_payload),
#             content_type='application/json'
#         )
...
#         response = client.delete('api/v0.1/sat_score_conversions?testid=' + str(self.SATScoreConversion1.pk))
#         self.assertEqual(response.status_code, status.HTTP_204_NO_CONTENT)
#
#     def test_delete_invalid_sat_score_conversion(self):
#         response = client.delete('api/v0.1/sat_score_conversions?testid=' + '-5')
#         self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
